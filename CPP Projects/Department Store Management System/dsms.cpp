...
void dept ::add_item()
{
    ...
    cout << "\n\n\t\t\t No. Of Item: ";
    cin >> no_item;
    file.open("Department Store Management System/item.txt", ios::out | ios::app);
...
void dept ::display_item()
{
    ...
    string itm_name;
    string c_name;
    file.open("Department Store Management System/item.txt", ios::in);
    if (!file)
    {
...
void dept ::update_item()
{
    ...
    cout << "----------------------------------------------"
            "----------------------------\n";
    file1.open("Department Store Management System/book1.txt", ios::app | ios::out);
    file.open("Department Store Management System/item.txt", ios::in);
    if (!file)
        cout << "\n\n File Opening Error...";
    else
    ...
    remove("Department Store Management System/item.txt");
    rename("Department Store Management System/book1.txt", "Department Store Management System/item.txt");
}
...
void dept ::delete_item()
{
    ...
    file1.close();
    remove("Department Store Management System/item.txt");
    rename("Department Store Management System/temp.txt", "Department Store Management System/item.txt");
}
